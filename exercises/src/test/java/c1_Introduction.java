...
//                .map(companyList::add)
//                .onErrorStop()
//                .subscribe(sub -> serviceCallCompleted.set(true))
//        //todo: change this line only
//        ;
//        Flux.error(new IllegalStateException()).log().subscribe();
//        new ArrayList<String>().ad
        Flux.fromIterable(new ArrayList<Integer>(1)).log().subscribe();
        fortuneTop5()
