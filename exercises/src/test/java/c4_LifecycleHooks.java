...
//                    subscription.
    ...
    public void be_there_early() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                //todo: change this line only
                .doFirst(() -> hooksTriggered.add("before subscribe")).log()
                ;
    ...
    public void atomic_counter() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                //todo: change this line only
                .doOnNext(integer -> System.out.println(counter.incrementAndGet()))
//                .doOnEach(integer -> System.out.println(counter.incrementAndGet())).log()
                ;
    ...
    public void successfully_executed() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                //todo: change this line only
                .doOnComplete(() -> completed.set(true)).log()
                ;
    ...
    public void need_to_cancel() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                //todo: change this line only
                .doOnCancel(() -> canceled.set(true)).log()
                ;
    ...
    public void terminator() {
        ...
        Flux<Integer> temperatureFlux = room_temperature_service()
                ...
                .doOnTerminate(() -> {
                    ...
                    System.out.println(hooksTriggeredCounter.incrementAndGet());
                })
                ;
//        hooksTriggeredCounter.setOpaque();
//        System.out.println(hooksTriggeredCounter);
    ...
    public void one_to_rule_them_all() {
        ...
        Flux<Integer> flux = Flux.just(1, 2, 3)
                ...
                .doOnEach(integerSignal -> {
                    signals.add(integerSignal.getType().name());
